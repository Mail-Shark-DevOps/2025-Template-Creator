...
set myYear to "None"
set filePath to "/Users/mattshark/Documents/Yearly Template Files/Template Working Files/2024-Templates/Version-Exports/2024_Version-12_Fixed-Envelope-Alternate-Indicias/Mail Shark Design Templates/Envelope Mailer/Envelope (#10)/Envelope (#10).indd"
--set filePath to "/Users/mattshark/Documents/Yearly Template Files/Template Working Files/2024-Templates/Version-Exports/2024_Version-12_Fixed-Envelope-Alternate-Indicias/Mail Shark Design Templates/Menu or XL Menu/Menu/Menu.indd"
*)
			...
			if (name extension of aFile as text) is "indd" then
				...
				*)
					...
					*)
					...
					-- indt
					(* This is the original way, but in the newer versions of indesign, you have to use a 
					POSIX path and the save command has to be done on the application level, 
					...
					--save activeDoc
					set myFileName to POSIX path of indtPath
					save activeDoc to myFileName with stationery
